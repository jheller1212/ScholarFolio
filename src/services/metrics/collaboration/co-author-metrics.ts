 ...
 *  in the owner's stored name — e.g. a profile for "Irina Lock" whose papers
 *  list her as "IJ Lock". isSameAuthor rejects that because the "j" has nothing
 ...
 *
 *  Capping at 2-char tokens keeps real first names out (e.g. "Ian Lock" stays a
